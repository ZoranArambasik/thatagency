    ...
    <div class="container">
        <div class="row">
            ...
            <?php wp_reset_postdata(); ?>
                ...
                <p class="soc-l-tem-single"><a href="mailto:<?php echo get_field('social_link') ?>"><?php echo get_field('social_link'); ?></a></p>
				<p class="soc-l-linked-single"><a target="_blank" href='<?php echo get_field('linkedin_url') ?>'><i class="fab fa-linkedin"></i></a></p>
                
                <div class="team-cont"><?php the_content(); ?></div>
            </div>
        </div>
    </div>
</section>
